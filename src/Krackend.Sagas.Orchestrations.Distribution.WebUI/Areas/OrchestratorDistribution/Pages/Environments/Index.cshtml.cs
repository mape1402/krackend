...
namespace Krackend.Sagas.Orchestrations.Distribution.WebUI.Areas.OrchestratorDistribution.Pages.Environments;

public sealed class IndexModel : PageModel
{
    private readonly IRuntimeEnvironmentInteractionService _service;

    public IndexModel(IRuntimeEnvironmentInteractionService service)
    {
        _service = service;
    }
