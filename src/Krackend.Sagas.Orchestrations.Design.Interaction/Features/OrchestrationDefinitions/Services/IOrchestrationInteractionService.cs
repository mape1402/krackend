...
/// </summary>
public interface IOrchestrationInteractionService
{
    /// <summary>
    ...
    Task<InteractionPagedResult<OrchestrationDefinitionModel>> GetAll(GetOrchestrationDefinitionsQuery query, CancellationToken cancellationToken = default);
}
