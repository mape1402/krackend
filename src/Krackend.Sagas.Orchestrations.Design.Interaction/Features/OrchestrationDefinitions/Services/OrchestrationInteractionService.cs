...
/// </summary>
public sealed class OrchestrationInteractionService : IOrchestrationInteractionService
{
    private readonly IMediator _mediator;

    /// <summary>
    /// Initializes a new instance of the <see cref="OrchestrationInteractionService"/> class.
    /// </summary>
    /// <param name="mediator">Mediator dependency.</param>
    public OrchestrationInteractionService(IMediator mediator)
    {
    ...
    public Task<InteractionPagedResult<OrchestrationDefinitionModel>> GetAll(GetOrchestrationDefinitionsQuery query, CancellationToken cancellationToken = default)
    {
        return _mediator.Send(query, cancellationToken);
    }
}
