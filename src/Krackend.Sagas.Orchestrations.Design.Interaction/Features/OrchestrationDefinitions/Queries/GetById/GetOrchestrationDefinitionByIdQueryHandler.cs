...
public sealed class GetOrchestrationDefinitionByIdQueryHandler : IRequestHandler<GetOrchestrationDefinitionByIdQuery, OrchestrationDefinitionModel>
{
    ...
    public GetOrchestrationDefinitionByIdQueryHandler(IOrchestrationDefinitionRepository repository, IOrchestrationDefinitionInteractionMapper mapper)
    {
    ...
    {
        global::Krackend.Sagas.Orchestrations.Design.Core.OrchestrationDefinition entity = await _repository.GetById(PrimitiveParser.ParseId(request.Id), cancellationToken);
