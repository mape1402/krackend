...
/// </summary>
public sealed class ParallelGroupInteractionService : IParallelGroupInteractionService
{
    private readonly IMediator _mediator;

    /// <summary>
    /// Initializes a new instance of the <see cref="ParallelGroupInteractionService"/> class.
    /// </summary>
    /// <param name="mediator">Mediator dependency.</param>
    public ParallelGroupInteractionService(IMediator mediator)
    {
