...
public sealed class UpdateParallelGroupDefinitionCommandHandler : IRequestHandler<UpdateParallelGroupDefinitionCommand, bool>
{
    ...
    {
        global::Krackend.Sagas.Orchestrations.Design.Core.ParallelGroupDefinition current = await _repository.GetById(PrimitiveParser.ParseId(request.Id), cancellationToken);
