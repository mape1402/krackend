...
public sealed class GetTriggerBindingByIdQueryHandler : IRequestHandler<GetTriggerBindingByIdQuery, TriggerBindingModel>
{
    ...
    public GetTriggerBindingByIdQueryHandler(ITriggerBindingRepository repository, ITriggerBindingInteractionMapper mapper)
    {
    ...
    {
        global::Krackend.Sagas.Orchestrations.Design.Core.TriggerBinding row = await _repository.GetById(
