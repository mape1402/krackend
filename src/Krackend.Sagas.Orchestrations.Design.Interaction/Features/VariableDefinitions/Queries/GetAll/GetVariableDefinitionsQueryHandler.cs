...
public sealed class GetVariableDefinitionsQueryHandler : IRequestHandler<GetVariableDefinitionsQuery, IEnumerable<VariableDefinitionModel>>
{
    ...
    public GetVariableDefinitionsQueryHandler(IVariableDefinitionRepository repository, IVariableDefinitionInteractionMapper mapper)
    {
    ...
    {
        IEnumerable<global::Krackend.Sagas.Orchestrations.Design.Core.VariableDefinition> rows = await _repository.GetAll(
