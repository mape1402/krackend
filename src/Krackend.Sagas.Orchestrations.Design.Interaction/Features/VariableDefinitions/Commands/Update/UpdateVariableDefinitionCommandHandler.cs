...
public sealed class UpdateVariableDefinitionCommandHandler : IRequestHandler<UpdateVariableDefinitionCommand, bool>
{
    ...
    {
        global::Krackend.Sagas.Orchestrations.Design.Core.VariableDefinition current = await _repository.GetById(PrimitiveParser.ParseId(request.Id), cancellationToken);
