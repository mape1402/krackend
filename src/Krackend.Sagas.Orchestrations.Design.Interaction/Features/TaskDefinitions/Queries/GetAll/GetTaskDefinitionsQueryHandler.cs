...
public sealed class GetTaskDefinitionsQueryHandler : IRequestHandler<GetTaskDefinitionsQuery, IEnumerable<TaskDefinitionModel>>
{
    ...
    public GetTaskDefinitionsQueryHandler(ITaskRepository repository, ITaskDefinitionInteractionMapper mapper)
    {
    ...
    {
        IEnumerable<global::Krackend.Sagas.Orchestrations.Design.Core.TaskDefinition> rows = await _repository.GetAll(
