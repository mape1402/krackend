...
public sealed class UpdateTaskDefinitionCommandHandler : IRequestHandler<UpdateTaskDefinitionCommand, bool>
{
    ...
    {
        global::Krackend.Sagas.Orchestrations.Design.Core.TaskDefinition current = await _repository.GetById(PrimitiveParser.ParseId(request.Id), cancellationToken);
