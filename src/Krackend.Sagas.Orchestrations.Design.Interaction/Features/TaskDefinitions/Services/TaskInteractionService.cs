...
/// </summary>
public sealed class TaskInteractionService : ITaskInteractionService
{
    private readonly IMediator _mediator;

    /// <summary>
    /// Initializes a new instance of the <see cref="TaskInteractionService"/> class.
    /// </summary>
    /// <param name="mediator">Mediator dependency.</param>
    public TaskInteractionService(IMediator mediator)
    {
