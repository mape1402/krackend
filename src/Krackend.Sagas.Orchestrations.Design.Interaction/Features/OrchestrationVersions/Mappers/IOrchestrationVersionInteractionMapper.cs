...
/// </summary>
public interface IOrchestrationVersionInteractionMapper
{
    /// <summary>
    ...
    InteractionPagedResult<OrchestrationVersionModel> ToPagedModel(PagedResult<OrchestrationVersion> source);
}
