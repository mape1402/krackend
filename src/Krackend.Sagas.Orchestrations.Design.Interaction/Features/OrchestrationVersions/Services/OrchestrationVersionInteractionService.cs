...
/// </summary>
public sealed class OrchestrationVersionInteractionService : IOrchestrationVersionInteractionService
{
    private readonly IMediator _mediator;

    /// <summary>
    /// Initializes a new instance of the <see cref="OrchestrationVersionInteractionService"/> class.
    /// </summary>
    /// <param name="mediator">Mediator dependency.</param>
    public OrchestrationVersionInteractionService(IMediator mediator)
    {
    ...
    public Task<InteractionPagedResult<OrchestrationVersionModel>> GetAll(GetOrchestrationVersionsQuery query, CancellationToken cancellationToken = default)
    {
        return _mediator.Send(query, cancellationToken);
    }
}
