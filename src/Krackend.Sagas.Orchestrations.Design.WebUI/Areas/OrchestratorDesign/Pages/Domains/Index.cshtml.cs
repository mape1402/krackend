...
namespace Krackend.Sagas.Orchestrations.Design.WebUI.Areas.OrchestratorDesign.Pages.Domains;
...
{
    private readonly IDomainInteractionService _service;

    /// <summary>
    /// Initializes a new instance of the <see cref="IndexModel"/> class.
    /// </summary>
    /// <param name="service">Domain interaction service.</param>
    public IndexModel(IDomainInteractionService service)
    {
    ...
    public async Task OnGetAsync(CancellationToken cancellationToken = default)
    {
        Rows = (await _service.GetAll(
            new GetDomainsQuery(new InteractionPagedSettings { PageNumber = 1, PageSize = 200 }),
