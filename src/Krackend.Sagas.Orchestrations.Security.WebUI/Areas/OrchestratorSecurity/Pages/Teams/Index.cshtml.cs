...
namespace Krackend.Sagas.Orchestrations.Security.WebUI.Areas.OrchestratorSecurity.Pages.Teams;
...
{
    private readonly ITeamInteractionService _service;

    /// <summary>
    /// Initializes a new instance of the <see cref="IndexModel"/> class.
    /// </summary>
    /// <param name="service">Team interaction service.</param>
    public IndexModel(ITeamInteractionService service)
    {
    ...
    private async Task LoadAsync(CancellationToken cancellationToken)
    {
        Rows = (await _service.GetAll(new GetTeamsQuery(
            new InteractionPagedSettings { PageNumber = 1, PageSize = 200 }), cancellationToken)).Rows.ToArray();
