...
public sealed class GetBranchRuleDefinitionByIdQueryHandler : IRequestHandler<GetBranchRuleDefinitionByIdQuery, BranchRuleDefinitionModel>
{
    ...
    public GetBranchRuleDefinitionByIdQueryHandler(IBranchRuleRepository repository, IBranchRuleDefinitionApplicationMapper mapper)
    {
    ...
    {
        global::Krackend.Sagas.Orchestrations.ControlPlane.Design.Core.BranchRuleDefinition row = await _repository.GetById(
