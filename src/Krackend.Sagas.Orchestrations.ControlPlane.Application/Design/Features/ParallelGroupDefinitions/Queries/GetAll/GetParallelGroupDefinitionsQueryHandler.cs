...
public sealed class GetParallelGroupDefinitionsQueryHandler : IRequestHandler<GetParallelGroupDefinitionsQuery, IEnumerable<ParallelGroupDefinitionModel>>
{
    ...
    public GetParallelGroupDefinitionsQueryHandler(IParallelGroupRepository repository, IParallelGroupDefinitionApplicationMapper mapper)
    {
    ...
    {
        IEnumerable<global::Krackend.Sagas.Orchestrations.ControlPlane.Design.Core.ParallelGroupDefinition> rows = await _repository.GetAll(
