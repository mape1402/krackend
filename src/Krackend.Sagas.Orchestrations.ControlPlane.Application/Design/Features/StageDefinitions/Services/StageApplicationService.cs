...
/// </summary>
public sealed class StageApplicationService : IStageApplicationService
{
    private readonly IMediator _mediator;

    /// <summary>
    /// Initializes a new instance of the <see cref="StageApplicationService"/> class.
    /// </summary>
    /// <param name="mediator">Mediator dependency.</param>
    public StageApplicationService(IMediator mediator)
    {
