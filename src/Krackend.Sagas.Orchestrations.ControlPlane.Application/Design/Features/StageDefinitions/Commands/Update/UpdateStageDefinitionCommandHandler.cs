...
public sealed class UpdateStageDefinitionCommandHandler : IRequestHandler<UpdateStageDefinitionCommand, bool>
{
    ...
    {
        global::Krackend.Sagas.Orchestrations.ControlPlane.Design.Core.StageDefinition current = await _repository.GetById(PrimitiveParser.ParseId(request.Id), cancellationToken);
