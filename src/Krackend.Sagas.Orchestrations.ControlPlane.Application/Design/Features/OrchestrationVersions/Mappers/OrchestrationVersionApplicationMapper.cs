...
/// </summary>
public sealed class OrchestrationVersionApplicationMapper : IOrchestrationVersionApplicationMapper
{
    /// <summary>
    ...
    public ApplicationPagedResult<OrchestrationVersionModel> ToPagedModel(PagedResult<OrchestrationVersion> source)
    {
        return new ApplicationPagedResult<OrchestrationVersionModel>(
            source.PageNumber,
            source.TotalPages,
            source.TotalRows,
            source.PageSize,
