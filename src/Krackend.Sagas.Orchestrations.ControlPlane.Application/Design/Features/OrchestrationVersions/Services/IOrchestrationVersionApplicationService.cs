...
/// </summary>
public interface IOrchestrationVersionApplicationService
{
    /// <summary>
    ...
    Task<ApplicationPagedResult<OrchestrationVersionModel>> GetAll(GetOrchestrationVersionsQuery query, CancellationToken cancellationToken = default);
}
