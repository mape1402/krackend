...
/// </summary>
public sealed class TriggerBindingApplicationService : ITriggerBindingApplicationService
{
    private readonly IMediator _mediator;

    /// <summary>
    /// Initializes a new instance of the <see cref="TriggerBindingApplicationService"/> class.
    /// </summary>
    /// <param name="mediator">Mediator dependency.</param>
    public TriggerBindingApplicationService(IMediator mediator)
    {
