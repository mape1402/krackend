...
public sealed class UpdateTriggerBindingCommandHandler : IRequestHandler<UpdateTriggerBindingCommand, bool>
{
    ...
    {
        global::Krackend.Sagas.Orchestrations.ControlPlane.Design.Core.TriggerBinding current = await _repository.GetById(PrimitiveParser.ParseId(request.Id), cancellationToken);
