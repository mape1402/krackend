...
/// </summary>
public interface IDomainApplicationService
{
    /// <summary>
    ...
    Task<ApplicationPagedResult<DomainModel>> GetAll(GetDomainsQuery query, CancellationToken cancellationToken = default);
}
