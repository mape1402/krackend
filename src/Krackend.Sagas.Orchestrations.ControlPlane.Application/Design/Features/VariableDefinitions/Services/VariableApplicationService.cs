...
/// </summary>
public sealed class VariableApplicationService : IVariableApplicationService
{
    private readonly IMediator _mediator;

    /// <summary>
    /// Initializes a new instance of the <see cref="VariableApplicationService"/> class.
    /// </summary>
    /// <param name="mediator">Mediator dependency.</param>
    public VariableApplicationService(IMediator mediator)
    {
