...
public sealed class GetVariableDefinitionByIdQueryHandler : IRequestHandler<GetVariableDefinitionByIdQuery, VariableDefinitionModel>
{
    ...
    public GetVariableDefinitionByIdQueryHandler(IVariableDefinitionRepository repository, IVariableDefinitionApplicationMapper mapper)
    {
    ...
    {
        global::Krackend.Sagas.Orchestrations.ControlPlane.Design.Core.VariableDefinition row = await _repository.GetById(
