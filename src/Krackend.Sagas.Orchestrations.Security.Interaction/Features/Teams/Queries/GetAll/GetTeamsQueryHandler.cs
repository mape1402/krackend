...
/// </summary>
public sealed class GetTeamsQueryHandler : IRequestHandler<GetTeamsQuery, InteractionPagedResult<TeamModel>>
{
    ...
    /// <inheritdoc />
    public async Task<InteractionPagedResult<TeamModel>> Handle(GetTeamsQuery request, CancellationToken cancellationToken)
    {
        ...
        return new InteractionPagedResult<TeamModel>(
            paged.PageNumber,
            paged.TotalPages,
            paged.TotalRows,
            paged.PageSize,
