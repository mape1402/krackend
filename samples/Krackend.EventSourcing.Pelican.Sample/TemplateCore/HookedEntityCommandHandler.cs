...
public abstract class HookedEntityCommandHandler<TRequest, TResponse, TEntity>
    ...
    where TEntity : class
{
    ...
    protected HookedEntityCommandHandler(IEnumerable<ICommandHandlerHook<TRequest, TEntity>> hooks)
    {
        _hooks = hooks;
    }
