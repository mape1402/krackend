...
public sealed class TemplateCompositionTests
{
    ...
    public void AddDefaults_registers_template_infrastructure()
    {
        ...
        Assert.Contains(typeof(Inventories.Business.Constants).Assembly, transactionOptions.RequestAssemblies);
    ...
    private static IConfiguration CreateConfiguration()
    {
        ...
        {
            ["ConnectionStrings:Default"] = "Server=(localdb)\\mssqllocaldb;Database=Inventories_Composition;Trusted_Connection=True;MultipleActiveResultSets=true",
            ["Pigeon:Domain"] = "Inventories",
    ...
    {
        public string ApplicationName { get; set; } = "Inventories.Tests";
