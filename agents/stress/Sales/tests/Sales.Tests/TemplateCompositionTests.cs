...
public sealed class TemplateCompositionTests
{
    ...
    public void AddDefaults_registers_template_infrastructure()
    {
        ...
        Assert.Contains(typeof(Sales.Business.Constants).Assembly, transactionOptions.RequestAssemblies);
    ...
    private static IConfiguration CreateConfiguration()
    {
        ...
        {
            ["ConnectionStrings:Default"] = "Server=(localdb)\\mssqllocaldb;Database=Sales_Composition;Trusted_Connection=True;MultipleActiveResultSets=true",
            ["Pigeon:Domain"] = "Sales",
